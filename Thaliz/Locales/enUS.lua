...
L["Message"] = "Message"
L["You can use %s and %c into your message. They will be replaced by the resurrected player's name and his class name."] = "You can use %s and %c into your message. They will be replaced by the resurrected player's name and class name."
