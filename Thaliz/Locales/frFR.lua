...
L["Message"] = "Message"
L["You can use %s and %c to inject into the message the resurrected player's name and class name."] = "Vous pouvez utiliser %p et %c pour injecter dans le message le nom du personnage ressuscité ainsi que le nom de sa classe."
